...
| `feature/settlement-period-navigation`（2026-08-14 工作区） | PR7 让月结中心默认展示最新已生成周期，支持周期切换；历史月结改用业务日期重叠查询，并补齐结清后文档下载回归 | 尚未发布；不新增 migration。UAT 需核对周期下拉、业务日期起止边界，以及已结清详情中的 Word/PDF 下载 |
