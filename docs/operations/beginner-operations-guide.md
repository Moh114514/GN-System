...
| `feature/customer-status-tree`（2026-08-14 工作区） | PR2 客户详情状态流转可视化及 Agent 详情“关联客户”中韩文案已加入 | 尚未合入 `develop`，不新增 migration；发布前执行完整门禁，并人工检查客户详情状态节点、流转箭头的当前/已过/可继续/不可达显示及中韩文案 |
