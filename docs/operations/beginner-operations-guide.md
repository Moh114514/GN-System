...
| `develop`（2026-08-14 工作区） | 国际化基础设施、PR-B/PR-C/PR-D 及规划 PR1–PR4 已加入；PR4 增加指定节假日客服提醒 | 尚未发布；PR1 包含不可逆 `2026_08_14_000100_remove_direct_sales_business` migration，PR2–PR4 不新增 migration。发布前备份数据库，核对 PR1 数据前置条件，并人工检查客户状态树、提醒文案、连续节假日规则的范围/负责人/去重/停用行为 |
