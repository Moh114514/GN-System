...
| 2026-08-14，当前 `develop` | 工作区未发布 | PR1–PR4 已加入：客户/订单归属收敛、客户状态树、提醒 UI 紧凑化及指定节假日客服提醒 | PR1 含不可逆 migration；PR2–PR4 不新增 migration。发布前按完整门禁执行，备份并核对 PR1 数据前置条件；UAT/Production 需人工验收状态树、提醒页面、预约前一天/当天客服联系文案及连续节假日规则的范围、负责人、去重和停用行为 |
