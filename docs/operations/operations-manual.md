...
| 2026-08-07，当前 `develop` | 工作区未发布 | 国际化 PR-A 基础设施及 PR-B 第一批界面：全局壳层、认证、设置、Dashboard、客户和订单日常页面支持 `zh_CN`/`ko_KR` | 含 `2026_08_07_000100_add_preferred_locale_to_users_table` migration；代理商、全局搜索、配置、异常/导出/队列等仍未完成，发布前备份数据库并核对既有用户均为 `zh_CN`，韩文入口暂未开放 |
