...
return [
    'errors' => [
        ...
        'business_group_bd_required' => '请选择启用中的 BD 经理。',
        'business_group_bd_same' => '新 BD 与当前 BD 相同，无需更换。',
        'business_group_bd_change_date_invalid' => '更换日期必须晚于当前 BD 的生效日期。',
        'business_group_agents_must_be_reassigned' => '该业务组仍有当前代理商归属，请先结束或转移代理商归属。',
    ],
    'audit' => [
        'dingtalk_mention_updated' => '钉钉提及绑定已更新',
        'impersonation_started' => '开始模拟用户身份',
        'impersonation_stopped' => '结束模拟用户身份',
        ...
        'business_group_bd_replaced' => '业务组 BD 已更换',
