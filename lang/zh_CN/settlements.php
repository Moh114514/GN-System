...
return [
    'bd_commission' => [
        ...
        'documents' => [
            ...
            'commission_total' => '订单提成合计', 'adjustment_total' => '人工调整合计', 'payable' => '应发提成', 'export' => '导出',
            'remark' => '本单据复用已保存的季度提成明细，状态：:status。', 'filename' => 'BD季度提成结算单-:period-:bd.:format',
            'headers' => ['order' => '订单/销售', 'occurred_on' => '发生日期', 'customer_agent' => '客户/代理商', 'sales' => '销售额 KRW', 'basis' => '提成基数 KRW', 'rate' => '提成率', 'commission' => '提成金额 KRW'],
        ],
    ...
    'detail' => [
        ...
        'payable_krw' => '韩元应付',
        'payable_cny' => '人民币应付',
        'estimated_payable' => '预计结算金额',
        'manual_source' => '手动输入',
        'quote_snapshot' => '1 CNY = :rate KRW · 来源：:source · 更新时间：:time',
        ...
        'approved_status' => '已审核',
        'documents_regenerate' => '重新生成', 'export' => '导出',
    ...
    'toasts' => [
        ...
        'documents_regenerated' => '正式结算单已重新生成。',
    ...
    'documents' => [
        ...
        'agent_label' => '代理商', 'status' => '月结状态', 'currency' => '结算币种', 'exchange_rate_label' => '结算汇率',
        'primary_amount' => '本期应结金额', 'total_consumption_label' => '消费合计', 'total_commission_label' => '推广费合计', 'payable_label' => '人民币应付',
        'remark_status' => '本单据状态：:status。金额来自月结生成快照。',
