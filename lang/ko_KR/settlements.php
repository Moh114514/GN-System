...
return [
    'archive' => [
        ...
        'search' => '에이전시 이름 또는 코드 검색', 'month' => '월', 'agent' => '에이전시',
    ...
    'center' => [
        ...
        'period_natural_month' => '정산 주기: 자연월', 'generation_day' => '생성일: 매월 10일', 'trigger_time' => '실행 시간', 'confirm_old_config' => '미완료 주기는 기존 설정을 계속 사용함을 확인', 'save_next_config' => '다음 생성 설정 저장',
